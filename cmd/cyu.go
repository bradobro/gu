...
func readFlags() *cyu.Config {
	...
	flag.StringVar(&(opts.StepMapDir), "stepmaps", cyu.DefaultConfig.StepMapDir, "step map files are found under here")
	flag.StringVar(&(opts.TemplateDir), "templates", cyu.DefaultConfig.TemplateDir, "the particular templates are found here")
